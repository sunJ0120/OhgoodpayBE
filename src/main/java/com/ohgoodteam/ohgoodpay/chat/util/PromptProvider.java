    ...
    public String getBasePrompt(String userName) {
        return """
                  ...
                  - 정보 수집 완료: 
                    ...
                    SEARCH_KEYWORD: [검색 키워드 - 상품명만, 가격 조건 제외]
                    MAX_PRICE: [예산 숫자만 - 단위 없이]
                
                【OUTPUT EXAMPLE】
                    예시 1)
                      모든 정보 확인 완료! ✨ 기분이 그저 그리고, 두부쿠 만드는 게 관심사고, 예산은 5만원까지네.
                      SEARCH_KEYWORD: 두부 만들기 키트
                      MAX_PRICE: 50000
                      
                    예시 2)
                      완벽해! 🎮 요즘 게임에 빠졌고 10만원까지 쓸 수 있구나.
                      SEARCH_KEYWORD: 게이밍 키보드
                      MAX_PRICE: 100000
                
                  【STRICT RULES】
                  - SEARCH_KEYWORD에 가격 관련 단어 절대 포함 금지 (예: "5만원", "이하", "미만")
                  - MAX_PRICE는 숫자만 (예: 50000)
